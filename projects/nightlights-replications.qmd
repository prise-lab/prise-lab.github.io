...
Your role is to go paper by paper and tell us, in plain language, where the nightlight data actually shows up in each study's main results. No prior research experience is required — these are skills you will learn on the job, with guidance from the faculty.
...
- Mentorship from the faculty and a strong letter of recommendation for future applications.
- A flexible commitment — a few hours per week, around your coursework.
